...
Grok video는 `grok-imagine-video`(기본) 또는 `grok-imagine-video-1.5-preview`를 사용합니다. 레퍼런스 수에 따라 T2V(0), I2V(1), Ref2V(2–7, 최대 10초)가 자동 선택됩니다. 1.5 preview는 Ref2V를 지원하지 않아 2장 이상이면 기본 모델로 전환됩니다. duration(1–15s), resolution(480p/720p), aspect ratio 컨트롤을 제공합니다.
